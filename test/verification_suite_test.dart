...
void main() {
  group('Security Suite (SQL Injection)', () {
    test('DriftLocalStore escapes table and column names correctly', () async {
      ...
      final maliciousColumn =
          'title", "malicious_col") VALUES ("hi", "ho"); --';

      await store.upsert(maliciousTable, '1', {maliciousColumn: 'value'});
